          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                Hi there! I am <strong>&nbsp;Ashwani Singh</strong>
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    <a href="https://github.com/ashwanidotsingh" target="_blank" rel="noopener noreferrer">
                  ...
                  <div>
                    <a href="https://www.linkedin.com/in/ashwani-singh-59a384193/" target="_blank" rel="noopener noreferrer">
